...
#definert alle variablene i flaga.
...
IntroText = ```For å tegne et flag tast in DrawNordicFlag("Ønsket flag") 
            Eksmelpel på dette kan være DrawNordicFlag("Norge")
            Tilgjengelige flag er Norge, Svergie, Danmark, Finland, Island og Farøyene```
